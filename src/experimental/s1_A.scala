...
//	val x = between( 0, a._2 + a._4._1 + g._1, width)
//	val y = between( 0, a._3 + a._4._2 + g._2, height)

	val x = a._2 + a._4._1 + g._1
	val y = a._3 + a._4._2 + g._2
...
def calcAttraction( g: Graph[ (String, Double, Double, (Double,Double,Double,Double)), Double ] ) : Graph[ (String, Double, Double, (Double,Double,Double,Double)), Double ] = {
	...
	dumpD( attr1.union(attr2), "ATTR12" )
//	dumpD( attr2, "ATTR2" )
